    ...
    <ModalShell open={open} onClose={onClose} maxWidth={720}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
            {([
              ...
              <button key={c.id} onClick={() => setFlow(c.id)} style={{
                ...
                onMouseEnter={e => { e.currentTarget.style.borderColor = '#EAB308'; e.currentTarget.style.background = '#FEF9C3'; }}
                ...
                <div style={{ width: 48, height: 48, borderRadius: 8, background: '#111111', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
                  <DynamicIcon name={c.icon} size={22} style={{ color: '#DC2626' }} />
                </div>
                ...
                <div style={{ marginTop: 'auto', display: 'inline-flex', alignItems: 'center', gap: 6, fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 700, fontSize: 12, color: '#DC2626', letterSpacing: '0.22em', textTransform: 'uppercase', paddingTop: 10 }}>
        ...
        <>
          <div style={{ ...modalBodyStyle, padding: '28px 26px' }}>
            <div style={{ padding: '14px 16px', background: '#F5F5F5', border: '1px solid #E5E5E5', borderRadius: 6, display: 'flex', alignItems: 'center', gap: 12, marginBottom: 24 }}>
              <Car size={22} style={{ color: '#DC2626' }} />
              <div>
                <div style={{ fontFamily: "'Barlow Condensed',sans-serif", fontSize: 11, fontWeight: 600, color: '#DC2626', letterSpacing: '0.22em', textTransform: 'uppercase' }}>Your Vehicle</div>
            ...
            <div style={{ textAlign: 'center', marginTop: 22, fontFamily: "'Barlow Condensed',sans-serif", fontSize: 16, fontWeight: 600, color: '#111111', letterSpacing: '0.16em', textTransform: 'uppercase' }}>
              <span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%', background: '#DC2626', marginRight: 10, verticalAlign: '2px', animation: 'pulse-dot 1.6s infinite' }} />
            ...
            <div style={{ marginTop: 22, padding: '12px 14px', background: '#F8F8F8', border: '1px dashed #D8CFBC', borderRadius: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap', fontFamily: "'Barlow Condensed',sans-serif", fontSize: 11, fontWeight: 600, letterSpacing: '0.18em', textTransform: 'uppercase', color: '#666666' }}>
              ...
              <div style={{ display: 'inline-flex', gap: 6 }}>
                {[{ id: 'active', label: 'Active' }, { id: 'early', label: 'Early' }, { id: 'delayed', label: 'Delayed' }, { id: 'ready', label: 'Ready' }].map(s => (
                  <button key={s.id} onClick={() => { if (s.id === 'ready') setFlow('oil-ready'); else setDemoState(s.id); }} style={{ padding: '6px 12px', background: demoState === s.id ? '#111111' : '#FFFFFF', color: demoState === s.id ? '#EAB308' : '#111111', border: '1px solid #E5E5E5', borderRadius: 3, cursor: 'pointer', fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 600, fontSize: 11, letterSpacing: '0.14em', textTransform: 'uppercase' }}>{s.label}</button>
                ))}
              </div>
            </div>
      ...
      {flow === 'oil-ready' && (
        <div style={{ ...modalBodyStyle, textAlign: 'center', padding: '40px 28px' }}>
          ...
          <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 15, color: '#666666', maxWidth: 460, margin: '0 auto', lineHeight: 1.6 }}>Head over to Ace Auto Repair &amp; Tires at 116 W Lincoln Ave, Woodland. See you soon!</p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap', marginTop: 26 }}>
            <a href="https://maps.google.com/?q=116+W+Lincoln+Ave+Woodland+CA+95695" target="_blank" rel="noopener" style={{ ...btnFilledGold, padding: '14px 22px', fontSize: 13, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
              <Navigation size={14} />Get Directions
            </a>
            <a href="tel:5306656099" style={{ ...btnOutlineNavy, padding: '14px 22px', fontSize: 13, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
        ...
        <>
          <div style={modalBodyStyle}>
            ...
            <p style={{ fontFamily: 'Inter,sans-serif', fontSize: 12.5, color: '#666666', marginTop: 14, lineHeight: 1.5 }}>
              Your ticket ID was emailed when you booked. Contact us at <a href="tel:5306656099" style={{ color: '#DC2626' }}>(530) 665-6099</a> if you need help finding it.
            </p>
          </div>
          <div style={modalFooterStyle}>
            <span />
      ...
      {flow === 'repair-loading' && (
        <div style={{ ...modalBodyStyle, textAlign: 'center', padding: '60px 28px' }}>
          <Loader2 size={40} style={{ color: '#DC2626', animation: 'spin 1s linear infinite', margin: '0 auto' }} />
      ...
      {flow === 'repair-notfound' && (
        <div style={{ ...modalBodyStyle, textAlign: 'center', padding: '40px 28px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 12, flexWrap: 'wrap' }}>
            ...
            <a href="tel:5306656099" style={{ ...btnOutlineNavy, padding: '12px 20px', fontSize: 13, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: 8 }}>
  ...
  return (
    <div style={modalBodyStyle}>
      ...
      <div style={{ padding: '14px 16px', background: '#F5F5F5', border: '1px solid #E5E5E5', borderRadius: 6, display: 'flex', alignItems: 'center', gap: 12, marginBottom: 22 }}>
        <Car size={22} style={{ color: '#DC2626' }} />
        <div>
          <div style={{ fontFamily: "'Barlow Condensed',sans-serif", fontSize: 11, fontWeight: 600, color: '#DC2626', letterSpacing: '0.22em', textTransform: 'uppercase' }}>
            {ticket.id}
          </div>
          <div style={{ fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 700, fontSize: 17, color: '#111111', marginTop: 2 }}>
      ...
      <div style={{ position: 'relative', padding: '6px 6px 0', marginBottom: 22 }}>
        ...
        <div style={{ position: 'absolute', left: 24, top: 24, height: 3, background: '#DC2626', borderRadius: 2, zIndex: 1, width: `calc(${progressPct * 100}% * (1 - 48px / 100%))`, maxWidth: 'calc(100% - 48px)', transition: 'width 400ms ease' }} />
          ...
          {STAGES.map((s, i) => {
            ...
            return (
              <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, flex: 1, minWidth: 0 }}>
                <div style={{ width: 50, height: 50, borderRadius: '50%', background: passed || isActive ? '#DC2626' : '#FFFFFF', border: `2px solid ${passed || isActive ? '#DC2626' : '#E5E5E5'}`, color: passed || isActive ? '#111111' : '#AAAAAA', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', transition: 'all 280ms', boxShadow: isActive ? '0 0 0 6px rgba(220,38,38,0.2)' : 'none' }}>
      ...
      {/* Status message */}
      <div style={{ background: '#111111', color: '#F5F5F5', borderRadius: 8, padding: '20px 22px', display: 'flex', gap: 14, alignItems: 'flex-start', borderLeft: '4px solid #DC2626' }}>
        <DynamicIcon name={active.icon} size={22} style={{ color: '#DC2626', flexShrink: 0, marginTop: 2 }} />
        <div>
          <div style={{ fontFamily: "'Barlow Condensed',sans-serif", color: '#DC2626', fontSize: 11, fontWeight: 700, letterSpacing: '0.28em', textTransform: 'uppercase', marginBottom: 6 }}>Status update</div>
      ...
      {(ticket.appointmentDate || ticket.appointmentTime) && (
        <div style={{ marginTop: 14, padding: '12px 16px', background: '#F5F5F5', border: '1px solid #E5E5E5', borderRadius: 6, fontFamily: 'Inter,sans-serif', fontSize: 13.5, color: '#333333' }}>
          <span style={{ fontFamily: "'Barlow Condensed',sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: '0.22em', textTransform: 'uppercase', color: '#DC2626', marginRight: 8 }}>Appointment</span>
  ...
  return (
    <div style={{ width: size, height: size, margin: '0 auto', position: 'relative' }}>
      <svg width={size} height={size} style={{ transform: 'rotate(-90deg)' }}>
        ...
        <circle cx={size / 2} cy={size / 2} r={r} fill="none" stroke="#DC2626" strokeWidth={stroke}
          strokeLinecap="round" strokeDasharray={`${dash} ${c - dash}`}
          style={{ transition: 'stroke-dasharray 600ms ease' }} />
      </svg>
      <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ fontFamily: "'Barlow Condensed',sans-serif", color: '#DC2626', fontSize: 11, fontWeight: 700, letterSpacing: '0.32em', textTransform: 'uppercase' }}>Time Remaining</div>
        <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: 56, lineHeight: 1, color: '#111111', letterSpacing: '0.02em', marginTop: 6, display: 'flex', alignItems: 'baseline', gap: 4 }}>
          ...
          <span style={{ color: '#DC2626', fontSize: 38 }}>:</span>
...
function ShopCard() {
  return (
    <div style={{ marginTop: 22, padding: '14px 16px', background: '#F5F5F5', border: '1px solid #E5E5E5', borderRadius: 6, display: 'flex', gap: 12, alignItems: 'flex-start' }}>
      <MapPin size={16} style={{ color: '#DC2626', flexShrink: 0, marginTop: 3 }} />
      <div>
        <div style={{ fontFamily: 'Inter,sans-serif', fontSize: 14, color: '#1A1A1A', fontWeight: 500 }}>116 W Lincoln Ave, Woodland, CA 95695</div>
        <a href="tel:5306656099" style={{ fontFamily: 'Inter,sans-serif', fontSize: 13, color: '#666666', textDecoration: 'none' }}>(530) 665-6099</a>
      </div>
    </div>
  );
}
