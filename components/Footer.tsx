...
const footerHeading: React.CSSProperties = { fontFamily: "'Barlow Condensed',sans-serif", color: '#DC2626', fontSize: 13, fontWeight: 700, letterSpacing: '0.28em', textTransform: 'uppercase', marginBottom: 18 };
      ...
      <div style={{ maxWidth: 1320, margin: '0 auto' }}>
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1.2fr', gap: 48, paddingBottom: 36, borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          <div>
            ...
            <p style={{ fontFamily: "'Playfair Display',serif", fontStyle: 'italic', color: 'rgba(255,255,255,0.6)', fontSize: 17, marginTop: 24, maxWidth: 320, lineHeight: 1.55 }}>"Affordable prices, honest mechanics, friendly service — that's the Ace Auto Repair &amp; Tires promise."</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={footerInfo}><MapPin size={14} style={{ color: '#EAB308', flexShrink: 0, marginTop: 3 }} /><span>116 W Lincoln Ave, Woodland, CA 95695</span></div>
              <div style={footerInfo}><Phone size={14} style={{ color: '#EAB308', flexShrink: 0, marginTop: 3 }} /><a href="tel:5306656099" style={{ color: 'rgba(255,255,255,0.75)', textDecoration: 'none' }}>(530) 665-6099</a></div>
              <div style={footerInfo}><Clock size={14} style={{ color: '#EAB308', flexShrink: 0, marginTop: 3 }} /><span>Mon–Sat: 9:00 AM – 6:00 PM<br /><span>Sunday: 9:00 AM – 4:00 PM</span></span></div>
            </div>
          </div>
        </div>
        <div style={{ paddingTop: 22, display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 12, fontFamily: "'Barlow Condensed',sans-serif", fontSize: 12, letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)' }}>
          <div>© 2026 Ace Auto Repair &amp; Tires · Woodland, CA</div>
          <div>116 W Lincoln Ave · (530) 665-6099</div>
        </div>
      </div>
