...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      to: customerEmail,
      subject: `Ticket Confirmed — ${ticketId} | Ace Auto Repair & Tires`,
      html: `
        ...
        <p>We'll be in touch soon. Questions? Call us at (530) 665-6099.</p>
        <p>— Ace Auto Repair &amp; Tires | 116 W Lincoln Ave, Woodland CA 95695</p>
      `,
    }).catch(() => {}); // non-fatal
